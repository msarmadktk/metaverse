...
const NewFeatures = ({imgUrl , title , text , index}) => (
  <motion.div variants={ fadeIn('right' , 'tween' , index*0.2 ,'1')} initial="hidden" whileInView="show" viewport={{once : false , amount:0.25}} className="flex flex-col mr-4 justify-start">
