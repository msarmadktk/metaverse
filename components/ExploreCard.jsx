...
const ExploreCard = ({id, imgUrl , title , active , handleClick , key , index , }) => (
  <motion.div
  ...
  >
    <img src={imgUrl} className='absolute h-full w-full rounded-[24px] object-cover ' alt="" />

  {
    active !== id ? (
      <h3 className='font-semibold sm:text-[26px] text-[18px] text-white absolute z-0 lg:bottom-20 lg:rotate-[-90deg] origin-[0,0]'>{title}</h3>
    ) : (
